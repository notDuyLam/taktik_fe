      ...
      <div className="flex min-h-screen bg-background">
        ...
        <div className="flex-1 flex items-center justify-center">
          <Alert variant="default" className="max-w-md mx-auto p-6">
            ...
            <Button
              onClick={() => router.push("/")}
              className="mt-4 col-start-2 w-full"
              variant="default"
            >
              Go Home
            </Button>
          ...
          <CardContent className="p-0">
            <div className="flex flex-col sm:flex-row sm:items-center gap-6">
              ...
              <div className="flex-1 text-center sm:text-left mt-0 px-6 pb-6 sm:pb-6 sm:border-l sm:border-border sm:pl-6">
                <h1 className="text-3xl font-bold text-foreground mb-1 mt-4 break-all">
                  {user.username}
                </h1>
                ...
                {user.bio && (
                  <p className="text-foreground/80 mt-2 mb-4 text-sm max-w-xl mx-auto sm:mx-0">
                    {user.bio}
                  </p>
                )}
                {/* Stats */}
                ...
                <div className="flex flex-wrap justify-center sm:justify-start gap-3 mt-2 min-h-[48px]">
                  {isOwnProfile ? (
                    <Button
                      ...
                      variant="secondary"
                      className="flex items-center px-4 py-2 text-base min-w-[140px]"
                    >
                    ...
                    <>
                      ...
                      <span
                        className="inline-block min-w-[140px] h-10 align-middle opacity-0 pointer-events-none select-none"
                        aria-hidden="true"
                      ></span>
                      <Button
